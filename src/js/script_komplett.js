const searchPrisjaktForItem = async (query) => {
  ...
  //     `https://www.prisjakt.no/_internal/graphql?version=3166a6&main=search&variables={"id":"search","query":${query},"sort":"score","order":"desc","offset":0,"limit":48,"filters":[{"id":"category_id","selected":[]},{"id":"brand_id","selected":[]},{"id":"lowest_price"},{"id":"user_rating"}],"productModes":["product","raw"],"categoryFilters":[],"brandFilters":[],"campaignId":4,"personalizationClientId":"","pulseEnvironmentId":"sdrn:schibsted:environment:undefined"}`,
  //     {
  //       mode: "no-cors",
  //     }
  //   );
